...
router.get("/:id/edit", isLoggedIn, isOwner ,upload.single("listing[image]"),listingControllers.editForm);

router.put("/:id", isLoggedIn, isOwner, upload.single("listing[image]"), listingControllers.update);
